                ...
                <form onSubmit={handleSubmit} className="pt-10 pb-20">
                    ...
                    <div className="mt-10 lg:mt-12">
                        <button
                            ...
                            className="w-full bg-gray-800 from-[#e9c400] to-[#ffd700] text-[#131313] font-bold tracking-wide py-4 px-8 rounded-sm hover:shadow-[0_0_10px_rgba(255,215,0,0.2)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 font-[Inter,sans-serif] text-sm uppercase"
                        >
